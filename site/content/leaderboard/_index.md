...
(function() {
  ...
  var wrappers = { composite:'lb-composite-wrapper', h1iso:'lb-h1iso-wrapper', h1wk:'lb-h1wk-wrapper', h2:'lb-h2-wrapper', h3:'lb-h3-wrapper', grpc:'lb-grpc-wrapper', ws:'lb-ws-wrapper' };
  ...
  /* Restore on load and back/forward */
